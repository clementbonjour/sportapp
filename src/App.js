...
function App() {
    ...
    const SVG = () => <div>
        <svg viewBox="0 0 392 914" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd"
            ...
            <g transform="translate(22.284 51.959) scale(1.77261)">
                ...
                <g clip-path="url(#a)">
                    <path
                        d="M76.51 51.453s10.936 10.7 16.162 10.384c8-.483 15.483-8.203 15.483-8.203l.428 18.917L76.99 62.114l-.48-10.66z"
                        fill-opacity=".06"/>
                </g>
            </g>
            <circle cx="169.926" cy="91.879" r="4.95" fill="#707070" transform="translate(1.897 -.283)"/>
            <circle cx="169.926" cy="91.879" r="4.95" fill="#707070" transform="translate(37.897 -.283)"/>
            <path
                d="M198.184 81.35c-1.746-.42-4.358-4.3-2.618-4.748 2.62-.672 13.5-.587 18.331.714 4.112 1.108 10.693 6.486 10.654 7.094-.039.61-7.108-3.006-10.887-3.444-4.395-.51-12.464 1.112-15.48.384z"
                fill="#707070"/>
            <path
                d="M179.582 81.35c1.746-.42 4.358-4.3 2.618-4.748-2.62-.672-13.5-.587-18.331.714-4.111 1.108-10.693 6.486-10.654 7.094.039.61 7.108-3.006 10.887-3.444 4.395-.51 12.464 1.112 15.48.384z"
                fill="#707070"/>
            <a href="/">
                <path onClick={handleClick} id={3} value={3}
                      d="M187.095 388.553c-8.429 0-15.273 6.843-15.273 15.272 0 8.43 6.844 15.273 15.273 15.273 8.43 0 15.272-6.843 15.272-15.273 0-8.429-6.843-15.272-15.272-15.272zm0 2.325c7.145 0 12.947 5.802 12.947 12.947 0 7.146-5.802 12.947-12.947 12.947-7.146 0-12.947-5.801-12.947-12.947 0-7.145 5.801-12.947 12.947-12.947zm0 2.972c5.505 0 9.975 4.47 9.975 9.975 0 5.506-4.47 9.976-9.975 9.976-5.506 0-9.975-4.47-9.975-9.976 0-5.505 4.47-9.975 9.975-9.975z"
                      fill="silver"/>
            </a><a href="/">
            <path onClick={handleClick} id={2} value={2}
                  d="M147.917 248.553c-8.43 0-15.273 6.843-15.273 15.272 0 8.43 6.844 15.273 15.273 15.273 8.429 0 15.272-6.843 15.272-15.273 0-8.429-6.843-15.272-15.272-15.272zm0 2.325c7.145 0 12.947 5.802 12.947 12.947 0 7.146-5.802 12.947-12.947 12.947-7.146 0-12.947-5.801-12.947-12.947 0-7.145 5.8-12.947 12.947-12.947zm0 2.972c5.505 0 9.975 4.47 9.975 9.975 0 5.506-4.47 9.976-9.975 9.976-5.506 0-9.975-4.47-9.975-9.976 0-5.505 4.469-9.975 9.975-9.975z"
                  fill="silver"/>
        </a><a href="/">
            <path onClick={handleClick} id={1} value={1}
                  d="M302.763 193.553c-8.429 0-15.273 6.843-15.273 15.272 0 8.43 6.844 15.273 15.273 15.273 8.429 0 15.272-6.843 15.272-15.273 0-8.429-6.843-15.272-15.272-15.272zm0 2.325c7.145 0 12.947 5.802 12.947 12.947 0 7.146-5.802 12.947-12.947 12.947-7.146 0-12.947-5.801-12.947-12.947 0-7.145 5.801-12.947 12.947-12.947zm0 2.972c5.505 0 9.975 4.47 9.975 9.975 0 5.506-4.47 9.976-9.975 9.976-5.506 0-9.975-4.47-9.975-9.976 0-5.505 4.469-9.975 9.975-9.975z"
                  fill="silver"/>
        </a><a href="/">
            <path onClick={handleClick} id={4} value={4}
                  d="M137.942 586.553c-8.43 0-15.273 6.843-15.273 15.272 0 8.43 6.844 15.273 15.273 15.273 8.429 0 15.272-6.843 15.272-15.273 0-8.429-6.843-15.272-15.272-15.272zm0 2.325c7.144 0 12.947 5.802 12.947 12.947 0 7.146-5.803 12.947-12.947 12.947-7.147 0-12.947-5.801-12.947-12.947 0-7.145 5.8-12.947 12.947-12.947zm0 2.972c5.505 0 9.975 4.47 9.975 9.975 0 5.506-4.47 9.976-9.975 9.976-5.506 0-9.975-4.47-9.975-9.976 0-5.505 4.469-9.975 9.975-9.975z"
                  fill="silver"/>
        </a></svg>
    </div>;


    const [rot, setRot] = useState({id: 0})


    function handleClick(e) {
        e.preventDefault()
        setRot({id: e.target.id})
        setForm(false)
    }
    ...
    const tra = sessionStorage.getItem('flames');
    /*sessionStorage.setItem('flames', 0);*/

    let cdn = sessionStorage.getItem('flames');

    function inc() {
        cdn = cdn - 1 + 2;
        sessionStorage.setItem('flames', cdn);
    ...
    return (
        <div className="App">
            ...
            <div className="margium">
                <SVG/>
                <div className="app-row" onClick={() => inc()}>
                    <span className="flames"> {cdn}</span>
                    <div className="ial" href="temps">Commercer l'entraînement<img src={Fleche} alt=">"/></div>
                </div>
            </div>
        </div>
    );
